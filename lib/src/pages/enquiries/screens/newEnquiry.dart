...
import 'package:sellerkitcalllog/src/pages/enquiries/widgets/EnqAssignUser.dart';
import 'package:sellerkitcalllog/src/widgets/Appbar.dart';
import 'package:sellerkitcalllog/src/widgets/custom_text_form_field.dart';
import '../../../../helpers/padings.dart';
import '../../../../helpers/screen.dart';
import '../../../controller/enquiryController/enquiryController.dart';
...
class NewEnquiryState extends State<NewEnquiry> {
  ...
  init() {
    setState(() {
      ...
      mobileno_arg = data[0]['Mobile'];
      // screen = data[1]['Screen'];
      context.read<NewEnqController>().setArgument(mobileno_arg, context);
    });
  }
                                ...
                                child: Column(
                                  children: [
                                    CustomTextform(
                                      ...
                                      focusErrorborderType:
                                          FocusErrorBorderType.type2,
                                      // )
                                    ),
                                    SizedBox(
                                      height:
                                              ...
                                              SizedBox(
                                                ...
                                                child: CustomTextform(
                                                  ...
                                                  enableborder:
                                                      EnableBorderType.type2,
                                                  focusborder:
                                                      FocusBorderType.type2,
                                                  errorborder:
                                                      ErrorBorderType.type2,
                                                  focusErrorborderType:
                                                      FocusErrorBorderType
                                                          .type2,
                                                  // )
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: CustomTextform(
                                                  ...
                                                  enableborder:
                                                      EnableBorderType.type7,
                                                  focusborder:
                                                      FocusBorderType.type7,
